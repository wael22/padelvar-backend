...
def create_test_data():
    ...
    with app.app_context():
        try:
            ...
            player_email = "player@padelvar.com"
...
def show_test_accounts():
    ...
    logger.info("  👑 Admin: admin@padelvar.com / admin123")
    logger.info("  🏢 Club: club@padelvar.com / club123") 
    logger.info("  👤 Player: player@padelvar.com / player123")
